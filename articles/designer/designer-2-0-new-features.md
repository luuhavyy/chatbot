...
The left side menu will also replace the pop-up window that was utilized for
certain functions.
...
Now you can quickly convert text between uppercase, lowercase, sentence case,
